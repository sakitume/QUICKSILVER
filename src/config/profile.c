...
const blackbox_preset_t blackbox_presets[] = {
    {
        .blackbox_fieldflags = (uint32_t)-1,
        .rate_divisor = 4,
    ...
    {
        .blackbox_fieldflags = (1 << BBOX_FIELD_GYRO_RAW) | (1 << BBOX_FIELD_LOOP) | (1 << BBOX_FIELD_TIME),
        .rate_divisor = 20,
        .name = "Gyro Raw, Rate Divisor=20",
        .name_osd = "GYRO RAW, RATE=20"
    },
};
...
{
    profile->blackbox_fieldflags = preset->blackbox_fieldflags;
